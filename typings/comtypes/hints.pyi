...
from typing import Any as Any, Callable, ClassVar, Concatenate, Generic, Iterator, List, NoReturn, Optional, ParamSpec, Protocol, Self as Self, Sequence, Tuple as Tuple, Type, TypeAlias, TypeVar, Union as _UnionT, overload
from comtypes import GUID as GUID, IUnknown as IUnknown
...
class LP_SAFEARRAY(ctypes._Pointer[tagSAFEARRAY], Generic[_CT]):
    ...
    _itemtype_: ClassVar[_CT]
    _vartype_: ClassVar[int]
    _needsfree: ClassVar[bool]
    @overload
    @classmethod
    def create(cls: Type[LP_SAFEARRAY[ctypes._Pointer[_T_IUnknown]]], value: Sequence[_T_IUnknown], extra: ctypes._Pointer[GUID] = ...) -> LP_SAFEARRAY[ctypes._Pointer[_T_IUnknown]]:
        ...
    ...
    @overload
    def unpack(self: LP_SAFEARRAY[ctypes._Pointer[_T_IUnknown]]) -> Sequence[_T_IUnknown]:
        ...
...
def put_or_putref(put: Callable[_P_Put, _R_Put], putref: Callable[_P_PutRef, _R_PutRef]) -> _UnionT[Callable[_P_Put, _R_Put], Callable[_P_PutRef, _R_PutRef]]:
    ...
...
class _SetOnlyNormalProperty(Generic[_T_Inst, _T_SetVal]):
    ...
    @overload
    def __get__(self, instance: _T_Inst, owner: Optional[Type[_T_Inst]]) -> NoReturn:
        ...
...
@overload
def normal_property(fget: Callable[[_T_Inst], _R_Get]) -> _GetOnlyNormalProperty[_T_Inst, _R_Get]:
    ...

@overload
def normal_property(*, fset: Callable[[_T_Inst, _T_SetVal], Any]) -> _SetOnlyNormalProperty[_T_Inst, _T_SetVal]:
    ...

@overload
def normal_property(fget: Callable[[_T_Inst], _R_Get], fset: Callable[[_T_Inst, _T_SetVal], Any]) -> _GetSetNormalProperty[_T_Inst, _R_Get, _T_SetVal]:
    ...
...
class _GetSetNamedProperty(Generic[_T_Inst, _P_Get, _R_Get, _P_Set]):
    ...
    @overload
    def __get__(self, instance: _T_Inst, owner: Optional[Type[_T_Inst]]) -> _GetSetBoundNamedProperty[_T_Inst, _P_Get, _R_Get, _P_Set]:
        ...
...
class _GetOnlyNamedProperty(Generic[_T_Inst, _P_Get, _R_Get]):
    ...
    @overload
    def __get__(self, instance: _T_Inst, owner: Optional[Type[_T_Inst]]) -> _GetOnlyBoundNamedProperty[_T_Inst, _P_Get, _R_Get]:
        ...
...
class _SetOnlyNamedProperty(Generic[_T_Inst, _P_Set]):
    ...
    @overload
    def __get__(self, instance: _T_Inst, owner: Optional[Type[_T_Inst]]) -> _SetOnlyBoundNamedProperty[_T_Inst, _P_Set]:
        ...
...
@overload
def named_property(name: str, fget: Callable[Concatenate[_T_Inst, _P_Get], _R_Get]) -> _GetOnlyNamedProperty[_T_Inst, _P_Get, _R_Get]:
    ...

@overload
def named_property(name: str, *, fset: Callable[Concatenate[_T_Inst, _P_Set], Any]) -> _SetOnlyNamedProperty[_T_Inst, _P_Set]:
    ...

@overload
def named_property(name: str, fget: Callable[Concatenate[_T_Inst, _P_Get], _R_Get], fset: Callable[Concatenate[_T_Inst, _P_Set], Any]) -> _GetSetNamedProperty[_T_Inst, _P_Get, _R_Get, _P_Set]:
    ...
...
_T_E = TypeVar("_T_E")
@overload
def to_dunder_iter(newenum: _UnionT[_Descriptor[_T_Inst, Iterator[_T_E]], Callable[[_T_Inst], Iterator[_T_E]]]) -> Callable[[_T_Inst], Iterator[_T_E]]:
    ...
...
@overload
def to_dunder_call(item: _UnionT[_GetSetNamedProperty[_T_Inst, _P_Get, _R_Get, ...], _GetOnlyNamedProperty[_T_Inst, _P_Get, _R_Get], Callable[Concatenate[_T_Inst, _P_Get], _R_Get],]) -> Callable[Concatenate[_T_Inst, _P_Get], _R_Get]:
    ...
...
@overload
def to_dunder_getitem(item: _UnionT[_GetSetNamedProperty[_T_Inst, _P_Get, _R_Get, ...], _GetOnlyNamedProperty[_T_Inst, _P_Get, _R_Get], Callable[Concatenate[_T_Inst, _P_Get], _R_Get],]) -> Callable[Concatenate[_T_Inst, _P_Get], _R_Get]:
    ...
...
@overload
def to_dunder_setitem(item: _UnionT[_GetSetNamedProperty[_T_Inst, ..., Any, _P_Set], _SetOnlyNamedProperty[_T_Inst, _P_Set],]) -> Callable[Concatenate[_T_Inst, _P_Set], Any]:
    ...
